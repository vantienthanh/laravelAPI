 ...
 * Generated for Laravel 5.5.43 on 2018-09-14 10:56:46.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
        ...
        {
            return \Modules\User\Guards\Sentinel::check();
        }
        ...
        {
            return \Modules\User\Guards\Sentinel::guest();
        }
        ...
        {
            return \Modules\User\Guards\Sentinel::user();
        }
        ...
        {
            return \Modules\User\Guards\Sentinel::id();
        }
        ...
        {
            return \Modules\User\Guards\Sentinel::validate($credentials);
        }
        ...
        {
            return \Modules\User\Guards\Sentinel::setUser($user);
        }
        ...
        {
            return \Modules\User\Guards\Sentinel::login($user);
        }
        ...
        {
            return \Modules\User\Guards\Sentinel::attempt($credentials, $remember);
        }
        ...
        {
            return \Modules\User\Guards\Sentinel::logout();
        }
        ...
        {
            return \Modules\User\Guards\Sentinel::loginUsingId($userId);
        }
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function csv($file, $filename, $status = 200, $headers = array())
        {
...
namespace Collective\Html { 
    ...
    class FormFacade {
         ...
         * @static 
         */ 
        public static function i18nInput($name, $title, $errors, $lang, $object = null, $options = array())
        {
         ...
         * @static 
         */ 
        public static function i18nInputOfType($type, $name, $title, $errors, $lang, $object = null, $options = array())
        {
         ...
         * @static 
         */ 
        public static function i18nTextarea($name, $title, $errors, $lang, $object = null, $options = array())
        {
         ...
         * @static 
         */ 
        public static function i18nSelect($name, $title, $errors, $lang, $choice, $object = null, $options = array())
        {
         ...
         * @static 
         */ 
        public static function i18nFile($name, $title, $errors, $lang, $object = null, $options = array())
        {
         ...
         * @static 
         */ 
        public static function normalInput($name, $title, $errors, $object = null, $options = array())
        {
         ...
         * @static 
         */ 
        public static function normalInputOfType($type, $name, $title, $errors, $object = null, $options = array())
        {
         ...
         * @static 
         */ 
        public static function normalTextarea($name, $title, $errors, $object = null, $options = array())
        {
         ...
         * @static 
         */ 
        public static function normalSelect($name, $title, $errors, $choice, $object = null, $options = array())
        {
         ...
         * @static 
         */ 
        public static function normalFile($name, $title, $errors, $object = null, $options = array())
        {
...
namespace Modules\Core\Blade\Facades { 
    ...
    class AsgardEditorDirective {
        ...
        {
            return \Modules\Core\Blade\AsgardEditorDirective::show($arguments);
        }
...
namespace Modules\Media\Image\Facade { 
    ...
    class Imagy {
        ...
        {
            return \Modules\Media\Image\Imagy::get($path, $thumbnail, $forceCreate);
        }
        ...
        {
            return \Modules\Media\Image\Imagy::getThumbnail($originalImage, $thumbnail);
        }
        
        /**
         * Create all thumbnails for the given image path
         *
         * @param \Modules\Media\Image\MediaPath $path
         * @static 
         */ 
        public static function createAll($path)
        {
            return \Modules\Media\Image\Imagy::createAll($path);
        }
        ...
        {
            return \Modules\Media\Image\Imagy::isImage($path);
        }
        ...
        {
            return \Modules\Media\Image\Imagy::deleteAllFor($file);
        }
...
namespace Modules\Media\Blade\Facades { 
    ...
    class MediaSingleDirective {
        ...
        public static function show($arguments)
        {
            return \Modules\Media\Blade\MediaSingleDirective::show($arguments);
        }
    ...
    class MediaMultipleDirective {
        ...
        public static function show($arguments)
        {
            return \Modules\Media\Blade\MediaMultipleDirective::show($arguments);
        }
    ...
    class MediaThumbnailDirective {
        ...
        public static function show($arguments)
        {
            return \Modules\Media\Blade\MediaThumbnailDirective::show($arguments);
        }
